...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          ...
          path: PhotoDetailScreenWidget.routePath,
          builder: (context, params) => PhotoDetailScreenWidget(),
        ),
        FFRoute(
          name: UploadScreenWidget.routeName,
          path: UploadScreenWidget.routePath,
